  ...
  document.getElementById(tabname).classList.add("active-tab");
   ...
   const projects = [
    ...
    },
    {
      ...
      websiteUrl: 'https://www.behance.net/gallery/174824905/Carousel-Instagram-Post-for-StudyMonk/modules/987244739',
    ...
    },
    {
      ...
      description: 'Net Run Rate (NRR) in cricket is a statistical method of analysing and compare the performance of a team usually during a multi-team tournament. The Net Run Rate plays a critical role to decide which team qualifies for the next round when two or more teams end up with the same number of points.',
      category: 'all'
    },
    {
      title: 'Poster Design',
      imageUrl: 'images/Museum Poster.png',
      websiteUrl: 'https://www.behance.net/gallery/174268297/Poster-Design-for-College-Museum/modules/984020541',
